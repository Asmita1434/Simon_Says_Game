Simon Says Game is a browser-based implementation of the popular electronic memory game. The goal is to repeat an increasingly complex sequence of colors and sounds.
